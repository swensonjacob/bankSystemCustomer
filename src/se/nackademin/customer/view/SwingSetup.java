...
public class SwingSetup {
    ...
    private static String bankPrinter = "src/se/nackademin/customer/resources/F25BankPrinter.ttf";
    private static String Raleway = "src/se/nackademin/customer/resources/Raleway.ttf";
    ...
    public static JLabel createLogo() {
        String logoPath = "src/se/nackademin/customer/resources/logo.png";
    ...
    private static JButton createIconButton(String fileName) {
        Icon icon = new ImageIcon("src/se/nackademin/customer/resources/" + fileName);
